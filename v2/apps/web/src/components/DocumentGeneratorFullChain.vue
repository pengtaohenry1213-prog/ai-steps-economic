...
<template>
  <div class="document-generator-fullchain">
    <div class="header">
      <h2>项目文档生成器</h2>
    ...
    <div class="input-section">
      ...
      <ElInput
        ...
        type="textarea"
        :rows="4"
        placeholder="111请输入项目需求描述，如：基于v1经济模型，进行v2升级，采用Vue3+TS技术栈，目标构建新一代在线协作平台..."
        :disabled="loading"
        class="user-input"
      />
      <ElButton
